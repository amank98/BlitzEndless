...
/**
 * Created by Aman on 1/4/2017.
 */

public class PermUpgradeThree extends ScreenAdapter implements GestureListener{
    ...
    public PermUpgradeThree(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("permUpThree.png"));
