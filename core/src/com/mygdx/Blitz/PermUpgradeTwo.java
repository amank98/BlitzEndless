...
public class PermUpgradeTwo extends ScreenAdapter implements GestureListener{
    ...
    public PermUpgradeTwo(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("permUpTwo.png"));
