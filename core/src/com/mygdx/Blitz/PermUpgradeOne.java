...
public class PermUpgradeOne extends ScreenAdapter implements GestureListener{
    ...
    public PermUpgradeOne(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("permUpOne.png"));
