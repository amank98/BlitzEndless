...
public class InstructionScreenTwo extends ScreenAdapter{
    ...
    public InstructionScreenTwo (Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("instru2.png"));
