...
public class TempUpgradeTwo extends ScreenAdapter implements GestureListener {
    ...
    public TempUpgradeTwo(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("tempUpTwo.png"));
