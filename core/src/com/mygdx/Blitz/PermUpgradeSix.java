...
public class PermUpgradeSix extends ScreenAdapter implements GestureListener{
    ...
    public PermUpgradeSix(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("permUpSix.png"));
