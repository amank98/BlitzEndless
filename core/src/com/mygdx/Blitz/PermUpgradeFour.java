...
public class PermUpgradeFour extends ScreenAdapter implements GestureListener{
    ...
    public PermUpgradeFour(Game game) {
        this.game = game;
    ...
    public void show() {
        ...
        dirTexture = new Texture(Gdx.files.internal("permUpFour.png"));
